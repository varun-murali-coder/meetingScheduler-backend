...
app.post(`${baseUrl}/forgotPassword`, userController.forgot);
/**
     * @apiGroup users
     * @apiVersion  1.0.0
     * @api {post} /api/v1/users/login api for user login.
     ...
     * @apiParam {string} email of the user. (body params) (required)
     * @apiParam {string} password of the user. (body params) (required)
     *@apiParam {string} confirm of the user for password. (body params) (required)
     * @apiSuccess {object} myResponse shows error status, message, http status code, result.
     * 
     * @apiSuccessExample {object} Success-Response:
         {
...
app.get(`${baseUrl}/reset`,userController.reset);
app.post(`/resetPassword`,userController.resetPassword);
app.get(`${baseUrl}/all`,auth.isAuthorized,userController.getAllUsers)
/**
     * @apiGroup users
     * @apiVersion  1.0.0
     * @api {get} /api/v1/users/all api for user details.
     *
     * @apiParam {String} authToken The token for authentication.(Send authToken as query parameter, body parameter or as a header)
...
app.get(baseUrl+'/view/:userId',auth.isAuthorized,userController.viewByUserId);
/**
     * @apiGroup users
     * @apiVersion  1.0.0
     * @api {get} /api/v1/users/view/:userId api for user details.
     *
     *  @apiParam {String} authToken The token for authentication.(Send authToken as query parameter, body parameter or as a header)
